...
IMAGE img_account_input_box_1;						// 账号输入框里的第1个数或字母									
IMAGE img_account_input_box_2;						// 账号输入框里的第2个数或字母									
IMAGE img_account_input_box_3;						// 账号输入框里的第3个数或字母									
IMAGE img_account_input_box_4;						// 账号输入框里的第4个数或字母									
IMAGE img_account_input_box_5;						// 账号输入框里的第5个数或字母									
IMAGE img_account_input_box_6;						// 账号输入框里的第6个数或字母									
IMAGE img_account_input_box_7;						// 账号输入框里的第7个数或字母									
IMAGE img_account_input_box_8;						// 账号输入框里的第8个数或字母									
IMAGE img_account_input_box_9;						// 账号输入框里的第9个数或字母									
IMAGE img_account_input_box_10;						// 账号输入框里的第10个数或字母									
IMAGE img_account_input_box_11;						// 账号输入框里的第11个数或字母									
IMAGE img_account_input_box_12;						// 账号输入框里的第12个数或字母									
IMAGE img_account_input_box_13;						// 账号输入框里的第13个数或字母									
IMAGE img_account_input_box_14;						// 账号输入框里的第14个数或字母									
IMAGE img_account_input_box_15;						// 账号输入框里的第15个数或字母									
IMAGE img_account_input_box_16;						// 账号输入框里的第16个数或字母	
...
IMAGE img_registration_sucess_text;					// 注册成功的文本
IMAGE img_registered_text;							// 账号已被注册的文本
...
void load_res() {
	...
	loadimage(&img_account_and_password_length_hint_text, _T("res/login_registration/account_and_password_length_hint_text.png"));
	...
	loadimage(&img_registration_sucess_text, _T("res/login_registration/registration_sucess_text.png"));
	loadimage(&img_registered_text, _T("res/login_registration/registered_text.png"));
